...
class PDOAdapter
{
  ...
  function __construct($dsn, $username, $password, $errorLogger) {
    try {
      ...
      /* Установка атрибута, объекту PDO
      *  ATTR_ERRMODE - Режим сообщений об ошибках,
      *  ERRMODE_EXCEPTION - Выбрасывать исключение.
      */ 
      $this->dbh->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
      $this->dbh->exec("SET NAMES 'utf8'"); // Кодировка соединения
      $this->dbh->exec("SET character_set_client = utf8"); // Кодировка запроса клиента
    }

    // Ловим ошибку, если она возникла.
